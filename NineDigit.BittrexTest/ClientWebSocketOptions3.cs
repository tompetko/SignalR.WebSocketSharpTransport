...
{
    /*public sealed class ClientWebSocketOptionsEx
    {
        ...
        internal WebHeaderCollectionEx _requestHeaders;
        internal List<string> _requestedSubProtocols;
        
        internal ClientWebSocketOptionsEx() { } // prevent external instantiation
        ...
        internal WebHeaderCollection RequestHeaders =>
            _requestHeaders ?? (_requestHeaders = new WebHeaderCollectionEx());
