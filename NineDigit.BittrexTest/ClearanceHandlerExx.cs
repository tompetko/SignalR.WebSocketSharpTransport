...
namespace NineDigit.BittrexTest
{
    ...
    /// </remarks>
    public class ClearanceHandlerExx : DelegatingHandler
    {
        /// <summary>
        ...
        /// </summary>
        public ClearanceHandlerExx() : this(new HttpClientHandler()) { }

        /// <summary>
        /// Creates a new instance of the <see cref="ClearanceHandler"/> class with a specific inner handler.
        /// </summary>
        /// <param name="innerHandler">The inner handler which is responsible for processing the HTTP response messages.</param>
        public ClearanceHandlerExx(HttpMessageHandler innerHandler) : base(innerHandler)
        {
        ...
        public string CfduidCookie { get; private set; }
        public string Cf_clearanceCookie { get; private set; }
        ...
        private void InjectCookies(HttpRequestMessage request)
        {
            ...
            this.Cf_clearanceCookie = clearanceCookie?.Value;
            this.CfduidCookie = idCookie?.Value;
